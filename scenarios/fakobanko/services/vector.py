...
DOCUMENTS = {
    "default": [
        Document(id="doc-001", content="Fakobanko offers competitive mortgage rates starting at 6.5% APR.", metadata={"type": "product"}),
        Document(id="doc-002", content="Our AI assistant FakoBot can help with account inquiries.", metadata={"type": "service"}),
    ],
    "internal": [
        Document(id="int-001", content="Internal API endpoint: /api/v2/customers/{id}", metadata={"type": "api", "sensitive": True}),
        Document(id="int-002", content="ML model uses vLLM on gpu cluster ml-gpu-01.", metadata={"type": "infrastructure", "sensitive": True}),
    ]
}
...
async def search(request: SearchRequest):
    ...
    results = [{"id": d.id, "content": d.content, "score": random.uniform(0.7, 1.0)} for d in docs[:request.top_k]]
