...
EMPLOYEES = [
    Employee(id="emp-001", name="Sarah Chen", email="schen@fakobanko.local", department="Executive", title="CEO"),
    Employee(id="emp-002", name="Mike Johnson", email="mjohnson@fakobanko.local", department="Technology", title="CTO"),
    Employee(id="emp-003", name="Lisa Park", email="lpark@fakobanko.local", department="Technology", title="VP Engineering"),
    Employee(id="emp-004", name="James Wilson", email="jwilson@fakobanko.local", department="Security", title="CISO"),
]
...
async def get_directory(request: Request):
    ...
    return {"employees": [{"name": e.name, "department": e.department} for e in EMPLOYEES], "total": len(EMPLOYEES)}
