...
class LLMConfig:
    ...
    def from_env(cls) -> LLMConfig:
        ...
        cfg.litellm_model_fallback = os.getenv("LITELLM_MODEL_CHAINSMITH_FALLBACK", cfg.litellm_model_fallback)
...
def get_llm_client(config: Optional[LLMConfig] = None, reload: bool = False) -> LLMClient:
    """
    ...
    if _cached_client is not None and not reload and config is None:
    ...
    if config is None:  # Only cache auto-detected config
