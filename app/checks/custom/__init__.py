...
The registry below is maintained by the Steward agent but can also be
edited manually. Steward validates after the fact — it is not a gatekeeper.
...
3. Run Steward validation to verify the check integrates cleanly
"""
