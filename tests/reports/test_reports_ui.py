...
class TestReportsPageStatic:
    ...
    def test_reports_html_exists(self):
        ...
        reports_path = Path(__file__).parent.parent.parent / "static" / "reports.html"
    ...
    def test_reports_html_has_report_types(self):
        ...
        content = (Path(__file__).parent.parent.parent / "static" / "reports.html").read_text()
    ...
    def test_reports_nav_link_in_index(self):
        ...
        content = (Path(__file__).parent.parent.parent / "static" / "index.html").read_text()
    ...
    def test_reports_nav_link_in_trend(self):
        ...
        content = (Path(__file__).parent.parent.parent / "static" / "trend.html").read_text()
        assert 'href="reports.html"' in content
...
class TestApiJsReportMethods:
    ...
    def test_api_js_has_report_methods(self):
        ...
        content = (Path(__file__).parent.parent.parent / "static" / "js" / "api.js").read_text()
        for method in [
...
class TestReportsRoute:
    ...
    def test_reports_route_exists(self):
        ...
        content = (Path(__file__).parent.parent.parent / "app" / "main.py").read_text()
